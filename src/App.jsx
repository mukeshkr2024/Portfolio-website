  ...
  return (
    <div className="">
      ...
      <section className=" h-screen px-20 py-10">
        ...
        <div className="flex w-full">
          <div className="w-[40%] flex flex-col gap-y-6">
            <h4 className="text-[53px] font-semibold">
              I help fill your business gaps{" "}
            </h4>

            <h5 className="text-[38px] font-medium text-[#5D5D5D]">
              Saving your day, Every day.
            </h5>

            <p className="text-[#000000] text-lg">
              I understand your firm&apos;s fundamental needs: to either
              increase revenue, save costs, or save time. I don&apos;t just talk
              about expertise; I deliver it.
            </p>
            ...
            <div className="flex w-full items-start gap-6">
              <button
                ...
                // style={{
                //   boxShadow: "#fff 2px 2px 0 0, #000 2px 2px 0 1.5px",
      ...
      <section className="bg-[#F3F3F1] w-full px-20 py-10 ">
        <div className="w-full flex">
          <div className="flex-1">
            <h5 className="text-[#000000] text-[48px] font-medium">
              Prateek Prasoon
            </h5>
            <div className="text-[19px] font-normal mt-10 flex flex-col gap-y-6">
              <p>
      ...
      <section className="px-20 py-10">
        <div className="flex w-full">
          <div className="flex-1">
            ...
            <div className="mt-10 text-[20px] text-[#4E4E4E] flex flex-col gap-y-6">
              <p>
                CloudPrism Solutions isn&apos;t just a workplace—it&apos;s a
                community. Here, you&apos;re not just an employee; you&apos;re a
                valued member of a team united by shared values yet diverse in
      ...
      <section className="mt-10">
        <h4 className="text-center text-[43px] font-semibold">
      ...
      <section className="bg-[#2E2E2E] h-52"></section>
    </div>
  );
};
  ...
  return (
    <div className="w-[270px]">
      ...
      <div className="flex flex-col items-start gap-y-2 mt-4">
        <h3 className="text-lg text-[#181818] font-bold">{title}</h3>
        <p className="text-[15px] text-[#4E4E4E]">{description}</p>
        <button className="bg-[#181818] rounded-[57px] text-white text-[17px] font-medium px-8 py-1.5">
          Read
        </button>
      </div>
    </div>
...
function InputBtn({ label }) {
  return (
    <div className="bg-[#181818] text-white rounded-[57px] w-[120px] h-[42px] font-medium flex items-center justify-center">
      {label}
    </div>
  );
}
